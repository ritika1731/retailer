    ...
    <h2 align="center">List All Customer</h2>
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="cutomer" items="${listCustomer}">
                <tr>
                    <td><c:out value="${cutomer.customerId}" /></td>
                    <td><c:out value="${cutomer.customerName}" /></td>
                    <td><c:out value="${cutomer.customerAddress}" /></td>
                    <td><c:out value="${cutomer.paymentMode}" /></td>
                   <%--  <td>
